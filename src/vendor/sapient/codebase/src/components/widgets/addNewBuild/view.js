...
(function () {
    ...
    angular
        ...
        .controller('AddNewBuildWidgetViewController', AddNewBuildWidgetViewController);

    AddNewBuildWidgetViewController.$inject = ['$scope', 'buildData', 'DisplayState', '$q', '$uibModal'];
    function AddNewBuildWidgetViewController($scope, buildData, DisplayState, $q, $uibModal) {
        var ctrl = this;
        var builds = [];
        ...
        ctrl.detail = function(build) {
            $uibModal.open({
                templateUrl: 'components/widgets/addNewBuild/detail.html',
                controller: 'AddNewBuildWidgetDetailController',
                controllerAs: 'detail',
                size: 'lg',
                resolve: {
                    build: function() {
