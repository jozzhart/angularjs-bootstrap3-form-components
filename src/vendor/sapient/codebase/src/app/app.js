...
(function () {
            ...
            $httpProvider.interceptors.push(function () {
                return {
                    request: function (config) {
                        ...
                        // TODO - need to be sure that we're not passing this parameter in during our build process, otherwise can remove.
    ...
    .config(function($stateProvider, $urlRouterProvider) {
      ...
      .state('health', {
        ...
        templateUrl: 'app/dashboard/views/status.html'
      })
