...
(function () {
    ...
    function CreateDashboardController($location, $uibModalInstance, dashboardData, userService, DashboardType, cmdbData, dashboardService) {
        ...
        ctrl.templates = [
            ...
            {value: 'custom', name:'Team Dashboard', type:DashboardType.CUSTOM},
            {value: 'template', name:'Team Dashboard-Speedy Lite', type:DashboardType.CUSTOM},
            {value: 'customllyods', name:'Team Dashboard-Speedy Lite OKR', type:DashboardType.CUSTOM},
            {value: 'aggregateDashboard', name:'Aggregate Dashboard', type:DashboardType.CUSTOM}  
        ];
        ...
        function submit(form) {
            ...
            if (form.$valid) {
                ...
                if(ctrl.dashboardType.id === 'team'){
                    submitData.aggrFlag = ctrl.aggrFlag
                }
                ...
                dashboardData
                    ...
                    .success(function (data) {
                        ...
                        console.log("Dashboard creation success.","Google Analytics");
                        dataLayer.push({
                            event: 'DashboardCreation',
                            eventCategory: 'Dashboard',
                            eventAction: 'Create Button Clicks',
                            eventLabel: ctrl.dashboardType.id,
                        })
                    ...
                    .error(function (data) {
                        ...
                        if(data.errorCode === 401) {
                          $modalInstance.close();
                            ...
                            form.dashboardTitle.$setValidity(errorMsg, false);
                        }
