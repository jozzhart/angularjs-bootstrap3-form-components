...
(function() {
	...
	function featureData($http) {
        ...
        var ftprReopenUrl = '/api/jiraMVP/ftprReopenRate';
        var projectSprintsDetailsApi = '/api/jiraMVP/sprintsDetails';		
        return {
			...
			ftprReopen: ftprReopen,
			projectSprintDetailRetrieves: projectSprintDetailRetrieves
		};
		 ...
		 * Retrieves all teams
		 */
		function ftprReopen(params) {
			
            return $http.get(HygieiaConfig.local ? testsecurityIssuesRoute : ftprReopenUrl, { params: params })
                .then(function (response) {
                    return response.data;
                });
		}
		/**
		 * Retrieves all Sprint status
		 */
		function projectSprintDetailRetrieves(params) {
			return $http.get(HygieiaConfig.local ? projectSprintsDetailsApi : projectSprintsDetailsApi, { params: params })
                .then(function (response) {
                    return response.data;
            });
		}
