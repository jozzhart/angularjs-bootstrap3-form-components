(function () {
    ...
    angular
        ...
        .controller('LibraryPolicyDetailsJSController', LibraryPolicyDetailsJSController);

    LibraryPolicyDetailsJSController.$inject = ['$scope', '$uibModalInstance', 'libraryPolicyResult'];
    function LibraryPolicyDetailsJSController($scope, $uibModalInstance, libraryPolicyResult) {
