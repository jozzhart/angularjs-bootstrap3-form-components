(function () {
    ...
    angular
        ...
        .controller('CodeAnalysisJSViewController', CodeAnalysisJSViewController);

    CodeAnalysisJSViewController.$inject = ['$scope', 'codeAnalysisData', 'testSuiteData', 'libraryPolicyData', '$q', '$filter', '$uibModal'];
    function CodeAnalysisJSViewController($scope, codeAnalysisData, testSuiteData, libraryPolicyData, $q, $filter, $uibModal) {
        var ctrl = this;
        ...
        function processLibraryPolicyResponse(response) {
            ...
            function showDetail(test) {
                $uibModal.open({
                    controller: 'TestDetailsJSController',
                    controllerAs: 'testDetails',
                    templateUrl: 'components/widgets/codeanalysisJS/testdetails.html',
                    size: 'lg',
                    resolve: {
                        testResult: function () {
                            return test;
            ...
            function showLibraryPolicyDetails(type,data) {
                $uibModal.open({
                    controller: 'LibraryPolicyDetailsJSController',
                    controllerAs: 'libraryPolicyDetails',
                    templateUrl: 'components/widgets/codeanalysisJS/librarypolicydetails.html',
                    size: 'lg',
                    resolve: {
