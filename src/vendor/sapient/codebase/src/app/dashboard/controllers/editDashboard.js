...
(function () {
    ...
    function EditDashboardController($uibModalInstance, dashboardData, userData, userService, dashboardItem, $scope, $q, cmdbData, dashboardService) {
        ...
        ctrl.aggrFlag = dashboardItem.aggrFlag;
        ...
        function renameSubmit() {           
	    	return $q.when(dashboardData.rename(dashboardItem.id, document.cdf.dashboardTitle.value, ctrl.dashboardType, ctrl.aggrFlag))
	    	         .then(function() {
