(function () {
    ...
    function addTeamController($scope, $uibModalInstance, collectorData, $timeout) {
        ...
        ctrl.dropdownConfig = {
            optionLabel: 'title',
            btnClass: 'btn-input',
            placeholder: 'Select an engineering team dashboard'
        };
        ...
        // this is a workaround to clear out values that are not valid Engineering Team Dashboard names
        ...
        (function() {
            collectorData.itemsByType('product').then(function(result) {
                ...
                // limit to Engineering Team Dashboard
                var boards = [];
