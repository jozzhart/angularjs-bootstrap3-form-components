(function () {
    ...
    angular
        ...
        .controller('TestDetailsJSController', TestDetailsJSController);

    TestDetailsJSController.$inject = ['$scope','$uibModalInstance', 'testResult', 'DashStatus'];
    function TestDetailsJSController($scope, $uibModalInstance, testResult, DashStatus) {
